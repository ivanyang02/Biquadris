...
void Xwindow::updateBoard(int player, const std::vector<std::vector<std::shared_ptr<Cell>>> &b, int rows, int cols, int score, int level, char next, bool blind, char hold) {
